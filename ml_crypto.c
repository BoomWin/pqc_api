...
#include "./sphincs-sha2-192s-simple/clean/api.h"
...
// 시드없이 일반 키 생성 함수
int sphincs_sha2_192s_keypai(uint8_t *pk, uint8_t *sk) {
    return PQCLEAN_SPHICSSHA2192simple_clean_crypto_sign_keypair(pk, sk);
}
